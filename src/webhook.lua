...
function webhooks.discordModernPurchase(URL, user, item, total, transactionID, addrs)
  expect(1, URL, "string")
...
function webhooks.discordModernInvalid(URL, user, transactionID, meta)
  local kristweb = "[KristWeb](https://krist.club/network/transactions/" .. transactionID .. ")"
  local openWithURI = "<krist://tx/" .. transactionID .. "> (URI)"
  ...
  local data = {
    ...
    embeds = {
      {
        title = user .. " failed to buy something.",
        color = "16750744",
        fields = {
          {
            name = "Meta",
        ...
        author = {
          name = "Someone failed to buy something!"
        },
        thumbnail = {
          url = "https://docs.krist.dev/favicon-128x128.png"
        },
