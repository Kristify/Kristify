...
(dcc.eventHandler~=nil)then dcc:eventHandler(_cc,...)end end end end end;if(aab)and not(bca)then
if(dbc.parent==nil)then if(_cc=="term_resize")then
dbc:setSize(_ca.getSize())aab=true end end end
if(bca)then
if(aab)then
if
(_cc=="monitor_resize")then
if(type(aca)=="string")then dbc:setSize(_ca.getSize())elseif(
type(aca)=="table")then
